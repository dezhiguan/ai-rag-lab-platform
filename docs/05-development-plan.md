...
## 当前：V11 Token 用量与成本监控（已完成）

| 任务 ID | 内容 | 状态 |
|---------|------|------|
| V11-01 | Token 估算服务、Debug/实验台 tokenUsage、Token 成本看板、查询日志持久化 | ✅ 已完成 |
| V11-02 | qwen/text-embedding-v4 Embedding Token 与成本纳入总成本统计 | ✅ 已完成 |
...
| 任务 ID | 内容 | 状态 |
|---------|------|------|
| V10.5-01 | 全局 UI/UX 优化：侧边栏分组导航、主题样式、项目总览 Tab 化、宽表横向滚动 | ✅ 已完成 |
...
| V10-02 | 体验账号只读模式与危险操作保护（后端 403 + 前端按钮禁用） | ✅ 已完成 |
